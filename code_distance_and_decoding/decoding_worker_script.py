...
if __name__ == "__main__":
    ...
    decoding_details["error_rate"] = np.logspace(np.log10(decoding_details["min_error_rate"]), np.log10(decoding_details["max_error_rate"]), decoding_details["n_error_rate"]).tolist()
