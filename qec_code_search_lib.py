...
def save_intermediate_results(
    ...
    file_path = os.path.join(slice_specific_subfolder, f'codes_chunk_{chunk_index}.pickle')
                            ...
                            for powers_B in get_valid_powers_for_summands(summand_combo_B, l, m, power_range_A, power_range_B):
                                try: 
                                    ...
                                    if temp_batch_size > max_size_bytes:
                                        ...
                                        logging.warning('Saving intermediate results with {} codes.'.format(len(code_configs)))
